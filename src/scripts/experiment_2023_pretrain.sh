...
python utils/make_config.py --batch_size 32 --lr_max 1e-3 --lr_min 1e-5  --max_epoch 30 --model bird_sed bird_sed --do_mixup True  --aug_ver 4 4 --loss_fn focal_clip_max focal_clip_max --duration 10 10 --model_path exp064 exp064
# 鳥なしデータ生成
