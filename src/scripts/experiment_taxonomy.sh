...
python utils/make_config.py --batch_size 32 --lr_max 1e-3 --lr_min 1e-5  --max_epoch 30 --model bird_taxonomy bird_taxonomy --do_mixup True  --aug_ver 4 4 --loss_fn focal_clip_max_taxonomy focal_clip_max_taxonomy --duration 10 10 --model_path exp111_sed_taxonomy_2020_2021_2022 exp111_sed_taxonomy_2020_2021_2022 --n_split 5 5
