...
python utils/make_sound_dataset.py --sound_dir ../data_2020/train_audio --save_dir ../dataset_2020 --meta_path ../data_2020/train_extended.csv
# 鳥なしデータ生成
...
# 2021, 22事前学習の設定作成
python utils/make_config.py --batch_size 32 --lr_max 1e-3 --lr_min 1e-5  --max_epoch 50 50 --model bird_sed_b1 bird_sed_b1 --do_mixup True --training_year 2020_2021_2022 2020_2021_2022  --aug_ver 4 4 --loss_fn bce_clip_max_v2_nocall_100 bce_clip_max_v2_nocall_100 --duration 10 10

pretrain_files="../result/*exp087_model=bird_sed_b1-training_year=2020_2021_2022-loss_fn=bce_clip_max_v2_nocall_100-aug_ver=4-duration=10*"
for pretrain_filepath in $pretrain_files; do
    if [ -d $pretrain_filepath ] ; then
        ...
        python utils/make_config.py --batch_size 32 --lr_max 1e-3 --lr_min 1e-5  --max_epoch 40 --model bird_sed_b1 --do_mixup True --aug_ver 4 4 --model_path $pretrain_filepath $pretrain_filepath --loss_fn bce_clip_max_v2_nocall_100 bce_clip_max_v2_nocall_100  --duration 10 10
