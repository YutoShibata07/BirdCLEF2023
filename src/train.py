...
def main():
    ...
    train_files = np.load('/media/aolab/untitiled/workspace/Kaggle/BirdCLEF2023/csv/train_files.npy')
    val_files = np.load('/media/aolab/untitiled/workspace/Kaggle/BirdCLEF2023/csv/val_files.npy')
    ...
    ss = pd.read_csv('/media/aolab/untitiled/workspace/Kaggle/BirdCLEF2023/data/sample_submission.csv')
